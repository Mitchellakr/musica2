  ...
  import {Repeat, Pause} from 'iconsax-react';
  
  export default function Fullplayer({musicData, setMusicData, playPause, setPlayPause, songIndex, 
    setSongIndex, setStreaming, streaming, currentPlayList, setCurrentPlaylist, audioRef,
...
setAudioTime(audioRef.current.currentTime)
  ...
  // }
      ...
      return (
        ...
        <img onError={(e)=>{e.target.src='https://images.unsplash.com/photo-1470225620780-dba8ba36b745?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxleHBsb3JlLWZlZWR8MXx8fGVufDB8fHx8&w=1000&q=80'}} 
        
        src={streaming ? musicData.thumbnail : currentPlayList[songIndex].backdrop} ></img>
        </div>

        <div className="full-player page-transition page-pad">
            
  
            <article className='md:px-12 px-4'>
               
            <div>
            <img className='full-player-img' onError={(e)=>{e.target.src='https://images.unsplash.com/photo-1470225620780-dba8ba36b745?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxleHBsb3JlLWZlZWR8MXx8fGVufDB8fHx8&w=1000&q=80'}} 
             src={ streaming ? musicData.thumbnail :currentPlayList[songIndex].backdrop}></img>
            </div>
    ...
    <div style={volumeSlider} id='volumeSlider'></div>
           ...
           <div className='w-full' id='duration' ref={seekBar} onClick={(e)=>seek(e)}>
          ...
          <feBlend mode="normal" in="SourceGraphic" in2="effect1_dropShadow_0_1" result="shape"/>
              ...
              <article className='flex md:flex-col items-center justify-center'>
              <div className='flex gap-9 items-center justify-self-center'>
              <svg onClick={()=>setShuffle(prev=>!prev)} className={shuffle ? 'active-icon player-icons' : 'player-icons'}  viewBox="0 0 16 17" xmlns="http://www.w3.org/2000/svg">
          ...
          <path d="M14.4933 4.82606C14.4933 4.81273 14.5 4.79939 14.5 4.79273C14.5 4.72606 14.4867 4.65939 14.46 4.59939C14.4333 4.53939 14.4 4.48606 14.3533 4.43939L13.02 3.10606C12.8267 2.91273 12.5067 2.91273 12.3133 3.10606C12.12 3.29939 12.12 3.61939 12.3133 3.81273L12.7867 4.28606L10.9667 4.27939C10.96 4.27939 10.96 4.27939 10.9533 4.27939C10.1867 4.27939 9.46667 4.65939 9.04 5.30606L4.78 11.6927C4.54 12.0527 4.13333 12.2727 3.7 12.2727H3.69333L2 12.2594C1.72667 12.2594 1.5 12.4794 1.5 12.7594C1.5 13.0327 1.72 13.2594 2 13.2594L3.7 13.2661C3.70667 13.2661 3.70667 13.2661 3.71333 13.2661C4.48667 13.2661 5.2 12.8861 5.62667 12.2394L9.88667 5.85273C10.1267 5.49273 10.5333 5.27273 10.9667 5.27273H10.9733L14 5.28606C14.0667 5.28606 14.1267 5.27273 14.1933 5.24606C14.2533 5.21939 14.3067 5.18606 14.3533 5.13939C14.3533 5.13939 14.3533 5.13273 14.36 5.13273C14.4 5.08606 14.44 5.03939 14.46 4.97939C14.48 4.93273 14.4867 4.87939 14.4933 4.82606Z"/>
            ...
            <img className='player-icons backward' onClick={prev} src={prevIcon}></img>
            ...
            <svg onClick={()=>setLoop(prev=>!prev)} className={loop ? 'active-icon player-icons ' : ' player-icons '}  viewBox="0 0 16 17" xmlns="http://www.w3.org/2000/svg">
